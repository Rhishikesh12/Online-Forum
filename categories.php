        ...
        if($answer == NULL){
            ...
            if($_POST["nul"]==0){
                if(strpos($_POST["preby"],$_SESSION["user"]) === false)
                    $que = "update quans set answer=CONCAT(answer,'<br></br><br>".$_POST["answer"]."'), answeredby=CONCAT(answeredby,', @ ".$_SESSION["user"]."') where question like '%".$_POST["question"]."%'";
                else
                    $que = "update quans set answer=CONCAT(answer,'<br><br>".$_POST["answer"]."'), answeredby = '".$_SESSION["user"]."' where question like '%".$_POST["question"]."%'";
            }
            else
                ...
                <center>
                    <a id="ada" href="#box1">
                        <div id="algo" class="img">
                            <div id="p" title="Open">Programming Related</div>
                        </div>
                    </a>
                    <a id="cso" href="#box2">
                        <div id="syll" class="img">
                            <div id="p" title="Open">Syllabus Related Questions</div>
                        </div>
                    </a>
                    <a id="t" href="#box3">
                        <div id="soft" class="img">
                            <div id="p" title="Open">Events Related Questions</div>
                        </div>
                    </a>
                </center>
